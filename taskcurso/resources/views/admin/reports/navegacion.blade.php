        ...
        @foreach($tiposReporte as $tipo => $info)
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                <div class="p-6">
                    ...
                    <div class="space-y-2">
                        <!-- Generar PDF -->
                        <a href="{{ route('admin.reports.pdf', ['tipo' => $tipo, 'fecha_inicio' => now()->subMonth()->format('Y-m-d'), 'fecha_fin' => now()->format('Y-m-d')]) }}" 
                           class="w-full bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 text-sm flex items-center justify-center"
                           target="_blank">
                        ...
                        <!-- Exportar Excel -->
                        <a href="{{ route('admin.reports.excel', ['tipo' => $tipo, 'fecha_inicio' => now()->subMonth()->format('Y-m-d'), 'fecha_fin' => now()->format('Y-m-d')]) }}" 
                           class="w-full bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 text-sm flex items-center justify-center"
                           target="_blank">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
